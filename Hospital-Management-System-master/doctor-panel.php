...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-ref" id="list-ref-list" role="tab" data-toggle="list" aria-controls="home"> Referr patient</a>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-header">
                                  <h4 class="modal-title">Choose hospital</h4>
                                ...
                                <div class="modal-body">
                                  <form action="./refer.php" method="POST">
                                    ...
                                    <input type="hidden" name="d_name" value="<?php echo $_SESSION['dname']; ?>">
                                    <?php
                                      include_once "./function4.php";
                                       $hospitals = getHospitals($con);
                                       echo "<select name='hs_id' style='width: 100%; height: 40px; padding: 0 5px;'>";
                                        foreach($hospitals as $hs) {
                                          echo "<option value=". $hs["hs_id"] . " >" . $hs["hs_name"] . "</option>";
                                        }
                                      echo "</select><br><br>";
                                    ?>                                      
                                    
                                    <button type="submit" name="submit" class="btn btn-primary btn-block"> Refer patient</button>
                                  </form>
                                </div>
